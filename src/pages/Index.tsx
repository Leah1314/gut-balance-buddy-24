            ...
            borderColor: '#D3D3D3'
                ...
                <CardContent className="p-3">
                  <div className="grid grid-cols-2 gap-3">
                    <Button onClick={() => setActiveTrackTab('food')} variant="ghost" className={`flex items-center justify-center space-x-2 h-11 rounded-full border transition-all duration-200 ${activeTrackTab === 'food' ? 'text-white border-transparent hover:opacity-90' : 'border-opacity-100 hover:border-opacity-100'}`} style={{
                  ...
                  if (activeTrackTab === 'food') {
                    ...
                    <Button onClick={() => setActiveTrackTab('stool')} variant="ghost" className={`flex items-center justify-center space-x-2 h-11 rounded-full border transition-all duration-200 ${activeTrackTab === 'stool' ? 'text-white border-transparent hover:opacity-90' : 'border-opacity-100 hover:border-opacity-100'}`} style={{
      ...
      borderColor: '#D3D3D3'
        ...
        <div className="max-w-md mx-auto px-6">
          <div className="grid grid-cols-3 gap-0">
            ...
            <button onClick={() => setActiveMainTab('chat')} className={`flex flex-col items-center justify-center py-3 transition-all duration-200 ${activeMainTab === 'chat' ? 'opacity-100' : 'opacity-60'}`} style={{
            ...
            <button onClick={() => setActiveMainTab('health')} className={`flex flex-col items-center justify-center py-3 transition-all duration-200 ${activeMainTab === 'health' ? 'opacity-100' : 'opacity-60'}`} style={{
