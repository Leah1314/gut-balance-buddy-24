...
const FoodAnalyzer = () => {
  ...
  return <div className="space-y-6">
      <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
        <TabsList className="grid w-full grid-cols-2 mb-6 bg-slate-50">
          <TabsTrigger value="manual" className="flex items-center space-x-2 data-[state=active]:bg-green-600 data-[state=active]:text-white" style={{
          ...
          <TabsTrigger value="camera" className="flex items-center space-x-2 data-[state=active]:bg-green-600 data-[state=active]:text-white" style={{
