            ...
            <CardContent className="space-y-4">
              <div className="space-y-3">
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-2">
                  {mealTypes.map(meal => <Button key={meal.id} variant={selectedMeal === meal.id ? "default" : "outline"} size="sm" onClick={() => setSelectedMeal(meal.id)} className={`text-slate-950 bg-neutral-50 ${meal.id === 'breakfast' ? 'border-2 border-orange-400' : ''}`}>
